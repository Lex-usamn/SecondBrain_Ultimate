"""
==============================================================================
RAG SYSTEM v2.0 - Sistema RAG Puro (NumPy + SciPy)
==============================================================================

Versão OTIMIZADA que não depende de ChromaDB para embeddings.

Funcionalidades:
- Embeddings TF-IDF via scikit-learn (matriz esparsa em memória)
- Busca vetorial por similaridade de cosseno (instantânea!)
- Busca híbrida (TF-IDF + keyword exata)
- Grafo de conhecimentos entre documentos
- Cache inteligente com TTL configurável
- Persistência em disco (JSON) para metadados
...
Criado: 11/04/2026
Atualizado: 11/04/2026 (v2.0 - Pure NumPy, sem ChromaDB embeddings)
Status: ✅ PRODUÇÃO
==============================================================================
"""
...
class DocumentoIndexado:
    ...
    Attributes:
        ...
        embedding: Vetor TF-IDF (densidade variável baseada no vocabulário)
...
class RAGSystem:
    ...
    def adicionar_documento(
        ...
        try:
            ...
            documento = DocumentoIndexado(
                ...
                conteudo=conteudo,
                metadata=metadata,
                embedding=None,  # Será preenchido após rebuild da matriz
    ...
    def buscar_similares(
        ...
        Args:
            ...
            n_results: Número máximo de resultados. Padrão: 5
            limiar_similaridade: Score mínimo (0-1). Padrão: 0.1
            
        Returns:
            list[DocumentoIndexado]: Documentos similares ordenados
        """
        try:
            # Verificar se temos documentos e matriz
            ...
            for doc_id in self._doc_ids:
                ...
                if doc and doc.embedding is not None:
                    ...
                    try:
                        sim = 1 - scipy_cosine(embedding_ref, doc.embedding)
    ...
    def _preprocessar_texto(self, texto: str) -> str:
        ...
        # Remover números soltos (opcional - comentar se quiser manter)
    ...
    def _salvar_dados_persistidos(self) -> None:
        ...
        Salva:
        - Metadados dos documentos (JSON)
        - Matriz TF-IDF (NPZ - formato numpy comprimido)
        - Configuração do vectorizer (vocabulário, etc.)
        """
        try:
...
if __name__ == "__main__":
    ...
    if rag.inicializar():
        ...
        doc1 = rag.adicionar_documento(
            conteudo="Como escalar canais dark no YouTube em 90 dias: estratégias de monetização com Adsense e afiliados",
            metadata={"tags": ["youtube", "monetizacao"], "categoria": "estrategia"},
            tipo=TipoConteudo.NOTA,
            reconstruir_matriz=True
        )
